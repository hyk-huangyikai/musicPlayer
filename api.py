...
class Crawler(object):
    ...
    def get_playlist_songs(self, playlist_id, limit=1000):
        ...
        url = 'https://music-api-jwzcyzizya.now.sh/api/get/playlist/netease?id={}'.format(playlist_id)
...
if __name__ == '__main__':
    ...
    # print(res)
    # res1 = netease.search_playlist('2018上半年最热新歌TOP50')
    res1 = netease.get_playlist_songs(2303649893)
    print(res1)
'''


c = Crawler()
a =  c.recommend_playlist()[1]
print(a.playlist_name, a.user_name, a.tags, a.description)
print(pl.playlist_id,pl.playlist_name,pl.user_name)
song=c.get_playlist_songs_qq(pl.playlist_id)[0]
